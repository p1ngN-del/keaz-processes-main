...
(function() {
    ...
    if (!procId) return;
    const outputsMap = {
    '1': [], '2': ['18', '21'], '3': [], '4': ['11', '13', '15', '32'], '4a': ['4', '23'], '4n': ['3', '29'], '5': ['6'], '6': [], '7': ['21'], '8': ['12'],
    '9': ['11', '3'], '10': ['11', '22'], '11': ['14'], '12': ['22'], '13': ['20'], '14': ['20'], '15': ['13', '32'], '16': [], '17': ['23', '24', '26'],
    '18': ['17', '19'], '19': ['24'], '20': ['25'], '21': ['18'], '22': ['8', '3'], '23': ['4', '4a'], '24': ['4'], '25': [],
    '26': ['31', '4a'], '27': ['17'], '28': ['30'], '29': [], '30': [], '31': [], '32': ['13', '20'], '34': ['4n', '8']
};
